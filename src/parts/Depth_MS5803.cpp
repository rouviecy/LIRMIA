...
void Depth_MS5803::Job(){} // Do nothing : this object should only be called by subscriber
...
void Depth_MS5803::Subscribe(Subscriber* subscriber){
	...
	keys[3] = 'P';
	keys[4] = '=';
	subscriber->Subscribe(keys, &(Depth_MS5803::Process_serial_data), (void*) this);
}
